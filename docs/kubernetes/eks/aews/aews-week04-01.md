...
#### 4.2.4. `aws-auth ConfigMap` (deprecated)
...
##### 4.2.5.2. Access Entry의 두 가지 권한 부여 방식
...
### 7.1. Terrafom EKS 모듈 + External Pod Identity 배포
...
### 7.2. Pod Identity의 Session Policy
